...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /* setting up the tab bar on the bottom of the screen, title as login and using the image link from Xcode, tag is like a number to determine which screen the user looks at (0 means first screen); self just means this current screen */
